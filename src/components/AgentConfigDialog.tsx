...
import { Bot, Sparkles, Code, FileText, Globe, Lightbulb, Briefcase, Search } from 'lucide-react';
...
const PRESET_TEMPLATES = [
  {
    name: 'BOSS直聘求职',
    description: '搜索数据分析实习岗位，辅助投递',
    systemPrompt: '你是BOSS直聘求职助手。帮助2027届数据分析相关专业应届生搜索杭州/深圳的数据分析、策略运营、增长、AI-Agent实习岗位。搜索BOSS直聘、牛客网等平台，筛选匹配岗位，生成结构化Excel汇总表。',
    icon: 'Briefcase',
    color: '#0052d9',
  },
  {
    name: '岗位匹配分析',
    description: '分析JD与个人技能匹配度',
    systemPrompt: '你是岗位匹配分析专家。根据用户的技能栈（Python/SQL/TensorFlow/Tableau等）分析JD中的技能要求，计算匹配度评分，给出针对性的技能提升建议和简历优化方案。用表格输出匹配度分析结果。',
    icon: 'Search',
    color: '#00a870',
  },
  {
